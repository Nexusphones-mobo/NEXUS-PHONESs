const faqResponses = {
  ...
  authentic: 'All phones are sourced from trusted partners and sold with a guarantee of authenticity and quality.',
  payment: 'We accept mobile money, bank transfer, and other secure payment methods. Ask for the best option for your order.',
  warranty: 'Most devices include a standard warranty. We can share details for each model once you choose the phone you want.',
  stock: 'Tell us which brands or models you want and we’ll share current stock, prices, and expected restock dates.',
  budget: 'Share your budget and we can recommend the best phones and accessories that fit it.',
  bulk: 'For bulk orders, let us know the quantity and device types. We’ll prepare a tailored quote with delivery details.',
  support: 'We offer after-sales support, warranty guidance, and service options to keep your phone protected.',
  accessories: 'We can add chargers, cases, screen protectors, and more. Just ask for the accessories you need.'
};
...
const keywordResponses = [
  ...
  {terms: ['accessory', 'charger', 'case', 'screen protector', 'accessories'], answer: faqResponses.accessories}
];
